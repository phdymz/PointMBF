...
root = '/media/ymz/11c16692-3687-420b-9787-72a7f9e3bdaf/3dmatch_rgbd_completed/3dmatch_rgbd_completed'
...
if __name__ == "__main__":
    ...
    split = 'train'
    data_dict = dict_path = os.path.join(f"3dmatch_{split}.pkl")
    ...
    for index in tqdm(range((len(instances)))):
        ...
        for i, id_i in enumerate(f_ids):
            ...
            save_root = os.path.join(root, s_instance[id_i]["dep_path"].replace('.depth', '.complete'))
