...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_root", type=str, default='/media/ymz/2b933929-0294-4162-9385-4fe3eec72189/ScanNetRGBD')
    parser.add_argument("--dict_path", type=str, default='scannet_train.pkl')
